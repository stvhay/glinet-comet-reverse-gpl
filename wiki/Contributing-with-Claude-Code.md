...
For general contribution guidelines, see [CONTRIBUTING.md](https://github.com/stvhay/glinet-comet-reverse-gpl/blob/main/CONTRIBUTING.md).
...
**Skills** are provided by plugins from `github:stvhay/my-claude-plugins`. Invoke them with `/skill-name` (e.g., `/brainstorming`, `/systematic-debugging`). See [CLAUDE.md](https://github.com/stvhay/glinet-comet-reverse-gpl/blob/main/CLAUDE.md#plugins) for the full plugin list.
