...
class TestOffsetManager:
    ...
    def test_load_from_shell_script_explicit_path(self, sample_offsets_file: Path) -> None:
    ...
    def test_load_from_shell_script_default_path(
        self, tmp_path: Path, sample_offsets_file: Path
    ) -> None:
    ...
    def test_load_from_shell_script_file_not_found(self, tmp_path: Path) -> None:
    ...
    def test_load_from_shell_script_no_output_dir(self) -> None:
    ...
    def test_get_existing_key(self, offset_manager: OffsetManager) -> None:
        """Test get() with existing key."""
        assert offset_manager.get("UBOOT_GZ_OFFSET") == "0x1E240"
        assert offset_manager.get("UBOOT_GZ_OFFSET_DEC") == 123456

    def test_get_missing_key_default(self, offset_manager: OffsetManager) -> None:
    ...
    def test_get_hex(self, offset_manager: OffsetManager) -> None:
    ...
    def test_get_hex_missing(self, offset_manager: OffsetManager) -> None:
        """Test get_hex() with missing offset returns None."""
        assert offset_manager.get_hex("NONEXISTENT") is None

    def test_get_dec(self, offset_manager: OffsetManager) -> None:
    ...
    def test_get_dec_missing(self, offset_manager: OffsetManager) -> None:
        """Test get_dec() with missing offset returns None."""
        assert offset_manager.get_dec("NONEXISTENT") is None

    def test_contains(self, offset_manager: OffsetManager) -> None:
    ...
    def test_getitem(self, offset_manager: OffsetManager) -> None:
    ...
    def test_getitem_missing_raises_keyerror(self, offset_manager: OffsetManager) -> None:
