...
class TestGitHubTokenRedaction:
    ...
    def test_github_secret_token(self) -> None:
...
class TestEmailRedaction:
    ...
    def test_email_in_command(self) -> None:
...
class TestPersonalPathRedaction:
    ...
    def test_macos_user_path(self) -> None:
    ...
    def test_multiple_user_paths(self) -> None:
...
class TestSSHRedaction:
    ...
    def test_ssh_url_with_user(self) -> None:
...
class TestMultipleRedactions:
    ...
    def test_password_and_email(self) -> None:
    ...
    def test_github_token_and_path(self) -> None:
...
class TestPreservesStructure:
    ...
    def test_preserves_command_structure(self) -> None:
    ...
    def test_preserves_line_ending(self) -> None:
